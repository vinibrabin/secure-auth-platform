...
export const DashboardScreen = () => {
  ...
  return (
    <div
      className={`flex min-h-screen font-lora w-full ${isDark ? "dark" : ""}`}
    >
...
const Sidebar = () => {
  ...
  return (
    <nav
      className={`sticky top-0 font-lora h-screen shrink-0 border-r transition-all duration-300 ease-in-out ${
        open ? "w-64" : "w-16"
...
const Option = ({
  ...
  return (
    <button
      ...
      className={`relative flex h-11 w-full font-lora items-center rounded-md transition-all duration-200 ${
        isSelected
...
const TitleSection = ({ open }: { open: boolean }) => {
  return (
    <div className="mb-6 border-b font-lora border-gray-200 dark:border-gray-800 pb-4">
...
const Logo = () => {
  return (
    <div className="grid size-10 font-lora shrink-0 place-content-center rounded-lg bg-linear-to-br from-blue-500 to-blue-600 shadow-sm">
      <svg
        width="20"
        height="auto"
        viewBox="0 0 50 39"
...
const ToggleClose = ({
  ...
  return (
    <button
      ...
      className="absolute bottom-0 font-lora left-0 right-0 border-t border-gray-200 dark:border-gray-800 transition-colors hover:bg-gray-50 dark:hover:bg-gray-800"
    >
      <div className="flex items-center p-3">
        <div className="grid size-10 place-content-center">
          <ChevronsRight
            className={`h-4 w-4 transition-transform cursor-pointer duration-300 text-gray-500 dark:text-gray-400 ${
              open ? "rotate-180" : ""
            }`}
          />
        </div>
...
const ExampleContent = ({
  ...
  return (
    <div className="flex-1 bg-gray-50 dark:bg-gray-950 p-6 overflow-auto font-lora">
      {/* Header */}
      <div className="flex items-center justify-between mb-8">
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            ...
            className="p-2 rounded-lg cursor-pointer bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 transition-colors"
          >
